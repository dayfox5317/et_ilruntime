...
{
    unsafe class ETModel_ETAsyncTaskMethodBuilder_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(ETModel.ETTask<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>), typeof(ETModel.IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ETModel.ETTask<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>).MakeByRefType(), typeof(ETModel.IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(ETModel.ETTask<UnityEngine.AssetBundle>), typeof(ETModel.IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ETModel.ETTask<UnityEngine.AssetBundle>).MakeByRefType(), typeof(ETModel.IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor> instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>[];
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>.Create();
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            object instance_of_this_method = (ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>)typeof(ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);

            ((ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>)instance_of_this_method).Start<ETModel.IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor>(ref @stateMachine);
        ...
        static StackObject* get_Task_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor> instance_of_this_method = (ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>)typeof(ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
        ...
        static StackObject* AwaitUnsafeOnCompleted_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ETModel.ETTask<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor> @awaiter = (ETModel.ETTask<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>)typeof(ETModel.ETTask<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor> instance_of_this_method = (ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>)typeof(ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);

            instance_of_this_method.AwaitUnsafeOnCompleted<ETModel.ETTask<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>, ETModel.IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor>(ref @awaiter, ref @stateMachine);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ETModel.ETTask<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>[];
        ...
        static StackObject* SetResult_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor @ret = (ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor)typeof(ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* AwaitUnsafeOnCompleted_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ETModel.ETTask<System.Boolean> @awaiter = (ETModel.ETTask<System.Boolean>)typeof(ETModel.ETTask<System.Boolean>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* AwaitUnsafeOnCompleted_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ETModel.ETTask<UnityEngine.AssetBundle> @awaiter = (ETModel.ETTask<UnityEngine.AssetBundle>)typeof(ETModel.ETTask<UnityEngine.AssetBundle>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor> instance_of_this_method = (ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>)typeof(ETModel.ETAsyncTaskMethodBuilder<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);

            instance_of_this_method.AwaitUnsafeOnCompleted<ETModel.ETTask<UnityEngine.AssetBundle>, ETModel.IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor>(ref @awaiter, ref @stateMachine);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ETModel.ETTask<UnityEngine.AssetBundle>[];
                        instance_of_arrayReference[ptr_of_this_method->ValueLow] = @awaiter;
                    }
                    break;
            }
        ...
        static StackObject* AwaitUnsafeOnCompleted_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ETModel.ETTask @awaiter = (ETModel.ETTask)typeof(ETModel.ETTask).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* AwaitUnsafeOnCompleted_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ETModel.ETTaskCompleted @awaiter = (ETModel.ETTaskCompleted)typeof(ETModel.ETTaskCompleted).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
