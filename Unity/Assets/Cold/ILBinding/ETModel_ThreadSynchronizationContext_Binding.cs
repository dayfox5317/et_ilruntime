...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ThreadSynchronizationContext_Binding
    {
        ...
        static StackObject* Update_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.ThreadSynchronizationContext instance_of_this_method = (ETModel.ThreadSynchronizationContext)typeof(ETModel.ThreadSynchronizationContext).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
