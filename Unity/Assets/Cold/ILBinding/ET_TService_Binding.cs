...
{
    unsafe class ET_TService_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(ETModel.ThreadSynchronizationContext), typeof(ET.ServiceType)};
            method = type.GetConstructor(flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Ctor_0);
            args = new Type[]{typeof(ETModel.ThreadSynchronizationContext), typeof(System.Net.IPEndPoint), typeof(ET.ServiceType)};
            method = type.GetConstructor(flag, null, args, null);
