...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ETAsyncTaskMethodBuilder_Binding
    {
        ...
        static StackObject* AwaitUnsafeOnCompleted_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ETModel.ETTask<libx.SceneAssetRequest> @awaiter = (ETModel.ETTask<libx.SceneAssetRequest>)typeof(ETModel.ETTask<libx.SceneAssetRequest>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* AwaitUnsafeOnCompleted_10(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ETModel.ETTask<UnityEngine.GameObject> @awaiter = (ETModel.ETTask<UnityEngine.GameObject>)typeof(ETModel.ETTask<UnityEngine.GameObject>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
