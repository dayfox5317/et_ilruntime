...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ETTask_1_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetException_0);
        ...
        static StackObject* SetException_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.ETTask<ILRuntime.Runtime.Intepreter.ILTypeInstance> instance_of_this_method = (ETModel.ETTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(ETModel.ETTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Create_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ETModel.ETTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Create(@fromPool);
