...
{
    unsafe class ETModel_ListComponent_1_ETTask_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.ListComponent<ETModel.ETTask>);
            args = new Type[]{};
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ETModel.ListComponent<ETModel.ETTask>.Create();
