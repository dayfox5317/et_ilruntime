...
//will auto register in unity
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            System_Collections_Generic_Dictionary_2_Int64_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            ...
            System_Collections_Generic_HashSet_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            System_Collections_Generic_HashSet_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Type_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int64_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_ValueCollection_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int64_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_ValueCollection_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Type_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_ValueCollection_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Type_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_ValueCollection_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Type_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_KeyValuePair_2_Type_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            ...
            System_Collections_Generic_Dictionary_2_Int64_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_KeyValuePair_2_Int64_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            ...
            System_Collections_Generic_Queue_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            ...
            System_Collections_Generic_Dictionary_2_Int32_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            ...
            System_Collections_Generic_List_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            System_Collections_Generic_List_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int32_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_ValueCollection_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int32_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_ValueCollection_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int32_SortedDictionary_2_Int32_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int32_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_KeyValuePair_2_Int32_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            System_Collections_Generic_SortedDictionary_2_Int32_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            ...
            ETModel_ETAsyncTaskMethodBuilder_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            ETModel_ETTask_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            ...
            System_Action_2_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Object_Binding.Register(app);
            ...
            System_Action_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            ...
            System_Collections_Generic_Dictionary_2_String_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_String_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_KeyValuePair_2_String_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            ...
            System_Collections_Generic_Dictionary_2_String_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_ValueCollection_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_String_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding_ValueCollection_Binding_Enumerator_Binding.Register(app);
            System_Collections_Generic_KeyValuePair_2_String_Int32_Binding.Register(app);
            ETModel_ListComponent_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            ...
            System_Collections_Generic_Queue_1_HashSet_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            System_Collections_Generic_Queue_1_Dictionary_2_Type_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
            System_Collections_Generic_Queue_1_Dictionary_2_Int64_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding.Register(app);
