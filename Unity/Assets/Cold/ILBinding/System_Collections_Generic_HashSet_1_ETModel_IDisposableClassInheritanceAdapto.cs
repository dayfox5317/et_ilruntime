...
{
    unsafe class System_Collections_Generic_HashSet_1_ETModel_IDisposableClassInheritanceAdaptor_Binding_IDisposableAdaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.HashSet<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>);
            args = new Type[]{};
        ...
        static StackObject* GetEnumerator_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.HashSet<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor> instance_of_this_method = (System.Collections.Generic.HashSet<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>)typeof(System.Collections.Generic.HashSet<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
