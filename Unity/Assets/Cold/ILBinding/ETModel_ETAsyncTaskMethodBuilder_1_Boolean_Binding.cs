...
{
    unsafe class ETModel_ETAsyncTaskMethodBuilder_1_Boolean_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.ETAsyncTaskMethodBuilder<System.Boolean>);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new ETModel.ETAsyncTaskMethodBuilder<System.Boolean>());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref ETModel.ETAsyncTaskMethodBuilder<System.Boolean> instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ETModel.ETAsyncTaskMethodBuilder<System.Boolean>[];
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ETModel.ETAsyncTaskMethodBuilder<System.Boolean>.Create();
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            object instance_of_this_method = (ETModel.ETAsyncTaskMethodBuilder<System.Boolean>)typeof(ETModel.ETAsyncTaskMethodBuilder<System.Boolean>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);

            ((ETModel.ETAsyncTaskMethodBuilder<System.Boolean>)instance_of_this_method).Start<ETModel.IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor>(ref @stateMachine);
        ...
        static StackObject* get_Task_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            ETModel.ETAsyncTaskMethodBuilder<System.Boolean> instance_of_this_method = (ETModel.ETAsyncTaskMethodBuilder<System.Boolean>)typeof(ETModel.ETAsyncTaskMethodBuilder<System.Boolean>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
