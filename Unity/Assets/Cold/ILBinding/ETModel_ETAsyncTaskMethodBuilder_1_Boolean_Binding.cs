...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ETAsyncTaskMethodBuilder_1_Boolean_Binding
    {
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            object instance_of_this_method = (ETModel.ETAsyncTaskMethodBuilder<System.Boolean>)typeof(ETModel.ETAsyncTaskMethodBuilder<System.Boolean>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
