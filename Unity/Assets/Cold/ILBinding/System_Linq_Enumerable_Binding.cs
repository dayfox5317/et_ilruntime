    ...
    unsafe class System_Linq_Enumerable_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("ToArray", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor[]), typeof(System.Collections.Generic.IEnumerable<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* ToArray_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor> @source = (System.Collections.Generic.IEnumerable<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>)typeof(System.Collections.Generic.IEnumerable<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = System.Linq.Enumerable.ToArray<ETModel.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>(@source);
