...
{
    unsafe class System_Collections_Generic_List_1_ETTask_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<ETModel.ETTask>);
            args = new Type[]{typeof(ETModel.ETTask)};
