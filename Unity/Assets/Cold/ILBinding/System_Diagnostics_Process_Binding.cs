...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Diagnostics_Process_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{};
            method = type.GetMethod("WaitForExit", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, WaitForExit_1);
            args = new Type[]{};
            method = type.GetMethod("get_ExitCode", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_ExitCode_2);
            args = new Type[]{};
            method = type.GetMethod("get_StandardOutput", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_StandardOutput_3);
            args = new Type[]{};
            method = type.GetMethod("get_StandardError", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_StandardError_4);
        ...
        static StackObject* WaitForExit_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_ExitCode_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_StandardOutput_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_StandardError_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
